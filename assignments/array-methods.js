...
// The large shirts won't be available for the event due to an ordering issue.  Get a list of runners with large sized shirts so they can choose a different size. Return an array named largeShirts that contains information about the runners that have a shirt size of L and log the result
    ...
    /** SOLUTION  */ 
    /*
    let fullName = runners.filter(
        function(item) {
            return person => person.shirt_size === "L";
        }
    );
    */
   /** SOLUTION 2 ARROW FUNCTION*/
...
// The donations need to be tallied up and reported for tax purposes. Add up all the donations into a ticketPriceTotal array and log the result
    ...
    */
    ...
    /** SOLUTION 2 ARROW FUNCTION*/
    let ticketPriceTotal = runners.reduce((total, amount) => total + amount.donation, 0);
...
// Problem 1
/** LIST OF RUNNERS IMPORTANT INFORMATION */
    let importantInfo = [];
    runners.forEach(runner => importantInfo.push(`First Name: ${runner.first_name} Last Name: ${runner.last_name} Email: ${runner.email} Company: ${runner.company_name}`));
    console.log(importantInfo);

// Problem 2
/** List of companies who attended the event and sort it*/
